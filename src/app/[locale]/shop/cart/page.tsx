...
export default function CartPage() {
  ...
  // Coupon codes, gift selection, and the real (delivery-method-aware)
  // shipping fee are all decided on the checkout page now — the cart just
  // shows what's in it. See checkout/page.tsx.
          ...
          <>
            ...
            <div className="vt-cart-summary">
              <div className="mt-8 pt-6 border-t border-gray-700 flex items-center justify-between">
                ...
                <span data-testid="cart-total" className="text-2xl font-bold">{formatPrice(subtotal)}</span>
              </div>
