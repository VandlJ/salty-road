    ...
    <section className="fixed inset-0 z-0 overflow-hidden">
      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center w-full">
        ...
        <div className="flex gap-4">
          <Link href="/register">
            <button className="mt-4 px-8 py-3 rounded-none font-bold text-lg tracking-widest uppercase bg-gradient-to-r from-white to-[#C0C0C0] text-[#222] shadow-lg border-2 border-[#C0C0C0] hover:from-[#C0C0C0] hover:to-white hover:text-[#444] hover:scale-105 hover:shadow-2xl transition-all duration-200 cursor-pointer">
              Register
            </button>
          </Link>
        </div>
