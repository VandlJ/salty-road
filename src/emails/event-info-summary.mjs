// One-off pre-event info blast, sent manually via scripts/sendInfoEmail.mjs
// to accepted registrations that haven't received it yet.
export function eventInfoSummaryEmail() {
